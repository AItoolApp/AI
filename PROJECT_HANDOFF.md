...
- 后期玩法：**小目标/里程碑 + 打卡达成烟花/彩蛋 + 悬浮桌宠**（v1.3/v1.4 候选，参考 `v1.2开源参考与轮子清单.md` §7、§8）。宠物方向：多类型可选（电/鱼/龙/龟/鲸/狐），点 1 下卖萌、点 2 下放大招（雷电/泡泡/喷火/喷水/幻光），声音可开关，支持换装、回城旋转缩小、召唤出场。预览：`宠物交互体验v2.html`。
...
8. P3：备案号回填（暂缓）；公安备案（等网站公安备案通过后再办）。
